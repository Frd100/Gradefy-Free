...
class SM2OptimizationTests: XCTestCase {
    ...
    func testPerformanceUnderLoad() async throws {
        ...
        for _ in 0..<10 {
            let _ = srsManager.getSmartCards(deck: testDeck, minCards: 20)
            let _ = srsManager.getDeckStats(deck: testDeck)
        }
    ...
    func testOptimizationReset() async throws {
        ...
        let _ = srsManager.getSmartCards(deck: testDeck, minCards: 5)
        let _ = srsManager.getDeckStats(deck: testDeck)
