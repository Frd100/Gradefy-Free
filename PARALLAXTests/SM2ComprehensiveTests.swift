...
final class SM2ComprehensiveTests: XCTestCase {
    ...
    func testSM2_DeterministicClock_DateCalculations() throws {
        ...
        let fixedDate = Date(timeIntervalSince1970: 1_704_067_200) // 1er janvier 2024, 12:00 UTC
    ...
    func testSM2_DeterministicClock_DSTTransition() throws {
        ...
        let beforeDST = Date(timeIntervalSince1970: 1_711_929_600) // 31 mars 2024, 02:00
        let afterDST = Date(timeIntervalSince1970: 1_711_933_200) // 31 mars 2024, 03:00 (après changement)
