...
class AudioManager: NSObject, ObservableObject {
    ...
    private func forceCompressLargeFile(_ url: URL, fileSize _: Int) async {
        Task.detached(priority: .utility) {
    ...
    private func performCompression(url: URL, fileSize: Int) async {
        ...
        if let tmpURL = await AudioCompressor.shared.compressAudio(at: url, bitrate: 128_000, forceMono: forceMono) {
            do {
                _ = try FileManager.default.replaceItemAt(url, withItemAt: tmpURL)
