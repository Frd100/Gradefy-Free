...
struct RevisionFlashcardView: View {
    ...
    private func flashcardCount(for _: Subject) -> Int {
        ...
        animationTask = Task { [weak self] in
            ...
            while !Task.isCancelled {
                ...
                let shouldContinue = await MainActor.run {
                    self.isAnimating && self.lastKnownPlayingState
                }
            ...
            NavigationLink(value: deck) {
                HStack(spacing: 15) {
                    ...
                    VStack(alignment: .trailing, spacing: 2) {
                        ...
                        // ✅ MODIFIÉ : Plus de limitation - Application entièrement gratuite
                        // Supprimé - Plus de vérification de limite
                    }
                    .padding(.trailing, 2)
...
// ✅ MODIFIÉ : Suppression du cas premium - Application entièrement gratuite
enum ActiveSheet: Identifiable, Equatable {
    ...
    var id: String {
        ...
        case let .editFlashcard(card): return "edit_\(card.id?.uuidString ?? "")"
        }
    }
    ...
    static func == (lhs: ActiveSheet, rhs: ActiveSheet) -> Bool {
        ...
        case (.modeSelection, .modeSelection):
            return true
        case let (.editFlashcard(lhsCard), .editFlashcard(rhsCard)):
...
struct DeckDetailView: View {
    ...
    private var flashcardLimitInfo: (canCreate: Bool, isGlobalLimit: Bool, remaining: Int, max: Int) {
        // Toujours autorisé - pas de limite
        return (canCreate: true, isGlobalLimit: false, remaining: Int.max, max: Int.max)
    }

    private var shouldShowLimitWarning: Bool {
        false // Plus d'avertissement de limite
    }
    ...
    // ✅ MODIFIÉ : Supprimé - Plus de message de limite - Application entièrement gratuite
    private var getLimitMessageWithColoredPro: some View {
        // Plus de message de limite
        return AnyView(EmptyView())
    }

    private var isToastClickable: Bool {
        // ✅ MODIFIÉ : Plus de toast de limite - Application entièrement gratuite
        return false
    }
    ...
    var body: some View {
        ...
        .sheet(item: $activeSheet) { sheet in
            ...
            case let .editFlashcard(flashcard):
    ...
    private var flashcardLimitToast: some View {
        ...
        .onTapGesture {
            // ✅ MODIFIÉ : Plus de redirection vers premium
    ...
    private var emptyStateView: some View {
        VStack {
            ...
            Button(action: {
                ...
                HStack {
                    Text(String(localized: "action_new_card"))
                }
