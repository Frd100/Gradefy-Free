...
struct PARALLAXApp: App {
    ...
    @State private var lastPremiumValidation: Date = Date.distantPast
    ...
    var body: some Scene {
        WindowGroup {
            ...
            .sheet(isPresented: $showPremiumView) {
                let _ = print("💎 [PARALLAXApp] PremiumView sheet présentée")
                return PremiumView()
            }
    ...
    private func handlePremiumURL() {
        print("💎 [PARALLAXApp] handlePremiumURL() appelé")
        logger.info("🔗 Ouverture de PremiumView")
        DispatchQueue.main.async {
            print("💎 [PARALLAXApp] showPremiumView = true")
